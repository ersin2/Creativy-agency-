...
class Setting(models.Model):
    ...
    about_page = RichTextUploadingField(verbose_name="Страница 'О нас'", null=True, blank=True)
    contact_page = RichTextUploadingField(verbose_name="Страница 'Контакты'", null=True, blank=True)
